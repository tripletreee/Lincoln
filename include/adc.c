...
void Init_ADC(void){
    ...
    AdcRegs.ADCSOC0CTL.bit.CHSEL 	= 0;    // SOC0, channel ADCINA0
    ...
    AdcRegs.ADCSOC1CTL.bit.CHSEL 	= 0;    // SOC1, channel ADCINA0
    ...
    AdcRegs.ADCSOC2CTL.bit.CHSEL 	= 1;    // SOC2, channel ADCINA1
    ...
    AdcRegs.ADCSOC3CTL.bit.CHSEL 	= 2;    // SOC3, channel ADCINA2
    ...
    AdcRegs.ADCSOC4CTL.bit.CHSEL 	= 3;    // SOC4, channel ADCINA3
    ...
    AdcRegs.ADCSOC5CTL.bit.CHSEL 	= 4;    // SOC5, channel ADCINA4
    ...
    AdcRegs.ADCSOC10CTL.bit.CHSEL 	= 8;    // SOC10, channel ADCINB0
    ...
    AdcRegs.ADCSOC11CTL.bit.CHSEL 	= 9;    // SOC11, channel ADCINB1
    ...
    AdcRegs.ADCSOC12CTL.bit.CHSEL 	= 0;    // SOC12, channel ADCINA0
    ...
    AdcRegs.ADCSOC13CTL.bit.CHSEL 	= 1;   // SOC13, channel ADCINA1
    ...
    AdcRegs.ADCSOC14CTL.bit.CHSEL 	= 2;    // SOC14, channel ADCINA2
    ...
    AdcRegs.ADCSOC15CTL.bit.CHSEL 	= 7;    // SOC15, channel ADCINA7
